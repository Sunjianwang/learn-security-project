...
/**
 * 自定义令牌生成规则
 * 直接借用{@link OAuth2AccessTokenGenerator}源码，稍作修改
 *
 * @author Sunjianwang
 * @version 1.0
 */
public class OAuth2CustomTokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken generate(OAuth2TokenContext context) {
        ...
        return new OAuth2AccessTokenClaims(OAuth2AccessToken.TokenType.BEARER,
                UUID.randomUUID().toString().toLowerCase(), accessTokenClaimsSet.getIssuedAt(), accessTokenClaimsSet.getExpiresAt(),
